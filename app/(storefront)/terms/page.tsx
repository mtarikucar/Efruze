...
export const metadata: Metadata = { title: "Şartlar · efruze" };

const heading = { eyebrow: "Hizmet Şartları", title: "Şartlar ve", titleEm: "koşullar." } as const;

export default async function TermsPage() {
  const locale = (await getLocale()) as AppLocale;
  const h = heading;
  const page = await safeGetStaticPage("terms", locale);
